...
public class ApplicationForm implements ActionListener {
    ...
    ApplicationForm() {
        ...
        f = new JFrame("Application Form by 22EARAD118");
        p1 = new JPanel();
        p2 = new JPanel();
        ...
        indob = new JFileChooser();
        indob.setDateFormatString("dd-MM-yyyy");
        indoa = new JFileChooser();
        ...
        if (e.getSource() == submit) {
            if (terms.isSelected()) {
                ...
                display.setText("Student's Name: " + name + "\nFather's Name: " + fname + "\nMother's Name: " + mname
                        + "\nGender: " + gender + "\nDate of Birth: " + (indob.validate() != null ? df.format(indob.validate()) : "Not Provided")
                        + "\nMobile Number: " + mobile + "\nE-mail ID: " + mail + "\nAddress: " + address
                        + "\nCourse: " + course + "\nBranch: " + branch + "\nDate of Admission: " + (indoa.validate() != null ? df.format(indoa.validate()) : "Not Provided"));
            } else {
